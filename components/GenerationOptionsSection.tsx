  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label htmlFor="toxicityLevel" className={labelClass}>
            갤러리 맵기 (수위)
          </label>
        ...
        <div>
          <label htmlFor="anonymousNickRatio" className={labelClass}>
            닉네임 비율
          </label>
          <div className="relative">
            <select
              ...
              className={`${inputClass} appearance-none cursor-pointer`}
            >
              {anonymousNickRatioOptions.map(nr => (
      ...
      <div className="p-5 bg-blue-50/50 rounded-2xl border border-blue-100">
        ...
        <div className="mt-6">
          ...
          <textarea
            ...
            rows={2}
            maxLength={500}
            aria-invalid={!!errors.discussionContext}
            aria-describedby={errors.discussionContext ? 'discussion-context-error' : undefined}
          />
